...
if [ $# != 9 ]; then
  echo "Usage: $0 <mean> <lda> <plda> <xvectors-cohort> <xvectors-sre18-dev-enroll> <xvectors-sre18-dev-test> <xvectors-sre19-enroll> <xvectors-sre19-test> <score-dir>"
  echo ""
...
plda=$3
xvectors_cohort=$4
xvectors_dev_enroll=$5
xvectors_dev_test=$6
xvectors_eval_enroll=$7
xvectors_eval_test=$8
score_dir=$9
...
$cmd $score_dir/log/asnorm_score_sre18.log \
  ...
  "ark:ivector-mean ark:$data/sre18_dev_enroll/spk2utt scp:$xvectors_dev_enroll/xvector.scp ark:- | ivector-subtract-global-mean $mean ark:- ark:- | transform-vec $lda ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
  "ark:ivector-subtract-global-mean $mean scp:$xvectors_dev_test/xvector.scp ark:- | transform-vec $lda ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
...
$cmd $score_dir/log/asnorm_score_sre19.log \
  ...
  "ivector-copy-plda --smoothing=0.0 $plda - |" \
  "ark:ivector-mean ark:$data/sre19_eval_enroll/spk2utt scp:$xvectors_eval_enroll/xvector.scp ark:- | ivector-subtract-global-mean $mean ark:- ark:- | transform-vec $lda ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
  "ark:ivector-subtract-global-mean $mean scp:$xvectors_eval_test/xvector.scp ark:- | transform-vec $lda ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
