...
if [ $# != 10 ]; then
  echo "Usage: $0 <mean> <lda> <whiten> <plda> <xvectors-cohort> <xvectors-sre18-dev-enroll> <xvectors-sre18-dev-test> <xvectors-sre19-enroll> <xvectors-sre19-test> <score-dir>"
  echo ""
...
plda=$4
xvectors_cohort=$5
xvectors_dev_enroll=$6
xvectors_dev_test=$7
xvectors_eval_enroll=$8
xvectors_eval_test=$9
score_dir=${10}
...
$cmd $score_dir/log/asnorm_score_sre18.log \
  ...
  "ark:ivector-mean ark:$data/sre18_dev_enroll/spk2utt scp:$xvectors_dev_enroll/xvector.scp ark:- | ivector-subtract-global-mean $mean ark:- ark:- | transform-vec $lda ark:- ark:- | transform-vec $whiten ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
...
$cmd $score_dir/log/asnorm_score_sre19.log \
  ...
  "ivector-copy-plda --smoothing=0.0 $plda - |" \
  "ark:ivector-mean ark:$data/sre19_eval_enroll/spk2utt scp:$xvectors_eval_enroll/xvector.scp ark:- | ivector-subtract-global-mean $mean ark:- ark:- | transform-vec $lda ark:- ark:- | transform-vec $whiten ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
